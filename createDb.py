...
query = [
    ...
    'CREATE TABLE IF NOT EXISTS "User" ("idUser" INTEGER NOT NULL, "Nama" TEXT NOT NULL, "tglLahir"	DATETIME NOT NULL, "Gender"	INTEGER NOT NULL, "tinggiBadan"	TEXT NOT NULL, "beratBadan"	TEXT NOT NULL, "NIK" TEXT NOT NULL,	"noHp" TEXT NOT NULL, "Alamat" TEXT NOT NULL, "nilaiUN"	INTEGER NOT NULL, "asalSekolah"	INTEGER NOT NULL, "jurusanPilihan" INTEGER NOT NULL, "namaAyah"	TEXT NOT NULL, "namaIbu" TEXT NOT NULL,	"pekerjaanAyah"	INTEGER NOT NULL, "pekerjaanIbu" INTEGER NOT NULL, "jmlSaudara"	TEXT NOT NULL,"status" INTEGER, "panitiaPenerima" INTEGER NOT NULL,	PRIMARY KEY("idUser"), FOREIGN KEY("status") REFERENCES "StatusSiswa"("idStatus"), FOREIGN KEY("panitiaPenerima") REFERENCES "Panitia"("idPanitia"), FOREIGN KEY("Gender") REFERENCES "Gender"("idGender"),	FOREIGN KEY("asalSekolah") REFERENCES "Gender"("idGender"),	FOREIGN KEY("jurusanPilihan") REFERENCES "Jurusan"("idJurusan"), FOREIGN KEY("pekerjaanIbu") REFERENCES "Pekerjaan"("idPekerjaan"),	FOREIGN KEY("pekerjaanAyah") REFERENCES "Pekerjaan"("idPekerjaan"))',
    'CREATE TABLE IF NOT EXISTS "Account" ("idAccount" INTEGER NOT NULL, "Username"	TEXT NOT NULL, "Password" TEXT NOT NULL, PRIMARY KEY("idAccount"))',
    'CREATE TABLE IF NOT EXISTS "DetailUser" ("idDetailUser" INTEGER NOT NULL, "idAccount" INTEGER NOT NULL, "idUser" INTEGER NOT NULL,	FOREIGN KEY("idUser") REFERENCES "User"("idUser"), FOREIGN KEY("idAccount") REFERENCES "Account"("idAccount"), PRIMARY KEY("idDetailUser"))',
    'CREATE TABLE IF NOT EXISTS "DetailPanitia" ("idDetailPanitia"	INTEGER NOT NULL, "idAccount" INTEGER NOT NULL, "idPanitia"	INTEGER NOT NULL, FOREIGN KEY("idAccount") REFERENCES "Account"("idAccount"), FOREIGN KEY("idPanitia") REFERENCES "Panitia"("idPanitia"), PRIMARY KEY("idDetailPanitia"))',
] 
